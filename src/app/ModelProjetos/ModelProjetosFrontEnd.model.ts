...
export const projetosFrontEnd = [
    ...
    {
        id: 13,
        nomeProjeto: "SENAICraft",
        holocronJedi: "assets/images/Holocron_Jedi.png",
        logoProjeto: "assets/images/Logo_SENAICraft.png",
        descricaoProjeto: "Um dos projetos mais legais que já fiz em toda minha carreira como programador: um jogo de perguntas sobre a DS15 no estilo de Minecraft. Esse jogo foi excelente, pois me fez visitar vários planetas como Kamino, Coruscant etc. na época da república galática, para aprender como fazer geolocalização em qualquer ponto da galáxia, tirar fotos em muitas paisagens bacanas, além de usar o SASS pela primeira vez!",
        ferramentas: [
            "assets/images/Icone_React.png",
            "assets/images/Icone_JavaScript.png",
            "assets/images/Icone_SASS.png",
    ...
    {
        id: 14,
        nomeProjeto: "CookieKnight",
        holocronJedi: "assets/images/Holocron_Jedi.png",
        logoProjeto: "assets/images/Logo_CookieKnight.jpg",
        descricaoProjeto: "Aqui temos uma colab muito legal: Hollow Knight e StarWars! Enquanto eu explorava o planeta Kamino, encontrei uma sala que havia uma caverna para baixo do oceano que cerca toda a cidade de Tipoca. Lá encontrei insetos muito divertidos e poderosos e isso me deu uma ideia: criar um jogo de clique envolvendo TODOS os insetos daquele reino já esquecido, chamado Hallownest.",
        ferramentas: [
            "assets/images/Icone_React.png",
            "assets/images/Icone_JavaScript.png",
            "assets/images/Icone_Tailwind.png",
    ...
    {
        id: 15,
        nomeProjeto: "BingoSong",
        holocronJedi: "assets/images/Holocron_Jedi.png",
        logoProjeto: "assets/images/Logo_BingoSong.png",
        descricaoProjeto: "Outra colab de jogos que tivemos foi de Hollow Knight: SilkSong com StarWars! Mas dessa vez foi em Coruscant, onde achei uma caverna um pouco mais na superfície. Lá, achei insetos ainda mais divertidos, emocionantes e engraçados com um único objetivo: chegar na Cidadela da Canção! E porque não parar um pouco no caminho para jogar um bingo, não? O site não é apenas um gerador de números, mas sim, um bingo divertido no tema de Fiarlongo.",
        ferramentas: [
            "assets/images/Icone_JavaScript.png",
            "assets/images/Icone_CSS.png",
            "assets/images/Icone_HTML.png",
